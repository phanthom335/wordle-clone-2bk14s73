    """
    Wordle Clone 2bk14s73
    =====================
    Classic discover game reimagined as a single-file Python script.
    ...
    APP_NAME    = "Wordle Clone 2bk14s73"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Classic discover game reimagined as a single-file Python script.")
